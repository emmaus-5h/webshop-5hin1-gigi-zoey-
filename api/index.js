...
function getProducts(request, response) {
  ...
  let data = []
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.brand AS brand, products.description AS description, products.type AS type, products.code AS code, products.price AS price FROM products ORDER BY name ASC')
...
function getProductById(request, response) {
  ...
  const sqlOpdracht = db.prepare('SELECT products.id AS id, products.name AS name, products.brand AS brand,  products.description AS description, products.type AS type, products.code AS code, products.price AS price FROM products WHERE id = ?')
