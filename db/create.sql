...
-- 9
insert into products (name, description, code, price) values ('AXIS-Y Dark Spot Correcting Glow Serum', 'A lightweight serum that helps brighten dark spots and hyperpigmentation, leaving your skin hydrated and glowing.
  Formulated with niacinamide and squalane to create a clear and radiant skin tone.', '26547832-2', 19.99);
-- 10
insert into products (name, description, code, price) values ('Beauty of Joseon Ginseng Cleansing Oil', 'A gentle, lightweight cleansing oil that gently dissolves and emulsifies wastes while adding moisture to your skin. 
